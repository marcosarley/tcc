    ...
    <table>
      ...
      if ($result->num_rows>0) {
        while($row = $result->fetch_assoc()) {
          echo "id: " . $row["ID"]. "<br>". " Nome: " .$row["nome"]."<br>". "Celular: " .$row["celular"]."<br>". "CPF: " . $row["cpf"]. "<br>". "RG: ".  $row["rg"]."<br>". "Telefone: " . $row["telefone"]."<br>"."Sexo: " . $row["escolhasexo"]. "<br>". "Necessidade Especial:" . $row["necessidade_especial"].  "<br>";
